...
(function (global) {
    ...
    function log() {
        var parts = ["[WebToken]"];
        var i;
        // console.error (not .log): this module's whole job is a silent background
        // refresh, so its progress/outcome is otherwise invisible - webOS's syslog
        // bridge only surfaces error-level console calls (confirmed this session),
        // and knowing whether the last refresh actually worked is worth having.
